import sunImg from "../assets/img/sun.jpg"; //太阳
import mercuryImg from "../assets/img/mercury.jpg"; //水星
import venusImg from "../assets/img/venus.jpg"; //金星
import earthImg from "../assets/img/earth.jpg"; //地球
import marsImg from "../assets/img/mars.jpg"; //火星
import jupiterImg from "../assets/img/jupiter.jpg"; //木星
import saturnImg from "../assets/img/saturn.jpg"; //土星
import uranusImg from "../assets/img/uranus.jpg"; //天王星
import neptuneImg from "../assets/img/neptune.jpg"; //海王星
import plutoImg from "../assets/img/pluto.jpg"; //冥王星
...
export const planetList = [sun, mercury, venus, earth, mars, jupiter, saturn, uranus, neptune, pluto];

export const solorSystem = {
  ...sun,
