import{_ as R,p as T,s as H,o as S,c as _,j as o,G as I,y as A,u as z,I as G,J as D,w as O,av as V}from"./chunks/framework.BB2QZFaM.js";import{S as W,P as N,W as U,b9 as q,X as J,A as j,G as X,U as v,n as $,g as K,L as Q,z as F,D as Y,ba as Z,bb as ss,h as is,m as as,r as ns,y as ls}from"./chunks/three.module.vz7QN0_z.js";import{O as hs}from"./chunks/OrbitControls.CfJ5KulZ.js";import{G as ts}from"./chunks/GLTFLoader.BzGVvzOG.js";import{D as ps}from"./chunks/DRACOLoader.BCJ1FlpS.js";import{g as es}from"./chunks/lil-gui.module.min.DqZR5HPe.js";import{R as ks,C as w}from"./chunks/vanilla-307d3a93.esm.B-3IM5_-.js";import"./chunks/commonjsHelpers.CqkleIqs.js";const rs={__name:"sixtythreeFile",setup(M){const h=A(null),c=A(null),a=new W,t=new N(35,window.innerWidth/window.innerHeight,.1,1e3),i=new U({antialias:!0,powerPreference:"low-power",preserveDrawingBuffer:!1});i.setSize(window.innerWidth,window.innerHeight),i.shadowMap.enabled=!0,i.shadowMap.type=q,i.toneMapping=J,i.toneMappingExposure=1,i.setPixelRatio(Math.min(window.devicePixelRatio,1.5));const r=new j(100);a.add(r);const e=new X(100,100);e.material.opacity=.2,e.material.transparent=!0,a.add(e);const y=new hs(t,i.domElement);y.enableDamping=!0,y.dampingFactor=.01,t.position.set(-5,5,12);let E=null,d=null;T(()=>{h.value.appendChild(i.domElement),m(),d=new es({container:c.value}),d.add(g.uSliceStart,"value",-Math.PI,Math.PI,.001).name("usliceStart"),d.add(g.uSliceArc,"value",0,Math.PI*2,.001).name("uSliceArc"),E=()=>{i.setSize(h.value.offsetWidth,h.value.offsetHeight),i.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),t.aspect=h.value.offsetWidth/h.value.offsetHeight,t.updateProjectionMatrix()},E(),window.addEventListener("resize",E)}),H(()=>{d.destroy(),cancelAnimationFrame(C),a.traverse(s=>{s.geometry&&s.geometry.dispose(),s.material&&(Array.isArray(s.material)?s.material.forEach(l=>l.dispose()):s.material.dispose()),s.texture&&s.texture.dispose()}),a.clear(),i.forceContextLoss(),window.removeEventListener("resize",E)});let C;const P=new $;function m(){const s=P.getElapsedTime();k&&(k.rotation.y=s*.1),y.update(),C=requestAnimationFrame(m),i.render(a,t)}new K;const B=new ts,u=new ps;u.setDecoderPath("/threeProjectDocs/draco/"),B.setDRACOLoader(u),new ks().load("/threeProjectDocs/aerodynamics_workshop.hdr",s=>{s.mapping=Q,a.background=s,a.backgroundBlurriness=.5,a.environment=s});const g={uSliceStart:new v(1.75),uSliceArc:new v(1.25)},f={csm_Slice:{"#include <colorspace_fragment>":`
